...
namespace FiftyLab.PrivateSchool.Controllers
{
    ...
    public class FormationController : Controller
    {
        ...
        [HttpGet]
        [Route("")]
        public async Task<IActionResult> GetFormations(CancellationToken ct, int page = 1, int limit = -1, string? sort = "CreatedOn", bool desc = true)
        {
            try
            {
        ...
        [HttpGet]
        [Route("search")]
        public async Task<IActionResult> SearchFormations(CancellationToken ct, string search = "", int page = 1, int limit = -1, string? sort = "CreatedOn", bool desc = true)
        {
            try
            {
                search = $"/{search}/ig";
        ...
        [HttpPatch]
        [Route("{id}")]
        public async Task<IActionResult> UpdateFormation(string id, [FromBody] FormationUpdateModel model, CancellationToken ct)
        {
